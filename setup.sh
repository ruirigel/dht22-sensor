...
(crontab -l ; echo "@reboot cd /home/$USER/dht22_server/ && ./start_dht22server.sh") 2>&1 | grep -v "no crontab" | sort | uniq | crontab -
(crontab -l ; echo "*/30 * * * * cd /home/$USER/dht22_server/ && ./check_dht22sensor.sh") 2>&1 | grep -v "no crontab" | sort | uniq | crontab -
